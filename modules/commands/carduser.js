...
module.exports.run = async function ({ api, event, args, Users }) {
  ...
  if(event.type == "message_reply") { uid = event.messageReply.senderID }
    ...
    const res = await axios.get(`https://api.leanhtruong.net/v2/info_user_facebook.php?api_key=http://api.leanhtruong.net/api/info?api_key=leanhtruong_KVf9Fi7U3q62rKjSvlsK&id=${uid}`); 
